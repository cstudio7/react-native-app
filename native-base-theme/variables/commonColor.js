...
export default {
  ...
  // Tab
  tabDefaultBg: platform === 'ios' ? '#F8F8F8' : Colors.primary,
  topTabBarTextColor: platform === 'ios' ? '#6b6b6b' : '#D1C4E9',
  topTabBarActiveTextColor: platform === 'ios' ? Colors.primary : '#fff',
  topTabBarBorderColor: platform === 'ios' ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === 'ios' ? Colors.primary : '#fff',
