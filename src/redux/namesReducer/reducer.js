...
const favoriteName = (state, action) => {
  ...
  const newName = {
    ...payload.name,
    isFavorite: (type === FAVORITESSCREEN_NAME_FAVORITE) || (type === LISTSCREEN_NAME_FAVORITE)
  };
...
export default createReducer(initialState, {
  ...
  [FAVORITESSCREEN_NAME_FAVORITE]: favoriteName,
  [LISTSCREEN_NAME_UNFAVORITE]: unfavoriteName,
  [FAVORITESSCREEN_NAME_UNFAVORITE]: unfavoriteName
});
